...
class RepoDetailsRobot {
    ...
    static RepoDetailsRobot init(){return new RepoDetailsRobot();}
    ...
    RepoDetailsRobot verifyDescription(String desc){
        onView(withId(R.id.tv_repo_description)).check(matches(withText(desc)));
        return this;
    }
    ...
    RepoDetailsRobot verifyContributorErrorVisibility(ViewMatchers.Visibility visibility){
    ...
    RepoDetailsRobot verifyContributorLoadingVisibility(ViewMatchers.Visibility visibility){
